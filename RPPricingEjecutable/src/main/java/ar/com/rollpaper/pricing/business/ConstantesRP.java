...
public class ConstantesRP {
	...
	public enum Acciones {
		CALCULADORA, SALIR, LISTA_PRECIO_X_CLIENTE, CARGA_PRECIO_CLIENTE, CARGA_CLIENTE_ESCLAVO, GENERAR_PRECIOS, CAMBIAR_DB, LISTA_PRECIO_GENERALES, CAMBIAR_SEPARADOR_DECIMAL, CAMBIAR_SEPARADOR_MILES, BUSQUEDA_VENCIDOS
	}
