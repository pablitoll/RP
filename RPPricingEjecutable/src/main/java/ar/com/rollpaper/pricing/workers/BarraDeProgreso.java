...
public class BarraDeProgreso extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public BarraDeProgreso(String titulo) {
	...
	public void inicializar() {
		if (PantPrincipalController.getPantallaPrincipal() != null) {
			this.setLocationRelativeTo(PantPrincipalController.getPantallaPrincipal().getDesktopPane());
		}
		setBotones(true);
		if (listaWorker != null) {
			executeWorkers();
	...
	//Todos estos metodos se podrian pasar a una calse que maneje lista de workers...
