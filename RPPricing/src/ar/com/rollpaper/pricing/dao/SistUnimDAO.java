...
public class SistUnimDAO {
	...
	public SistUnim findById(java.lang.String id) {
		log.debug("getting SistUnim instance with id: " + id);
		try {
			SistUnim instance = (SistUnim) sessionFactory.getCurrentSession()
					.get("ar.com.rollpaper.pricing.beans.rpdb.SistUnim", id);
			if (instance == null) {
