...
public class CargaPrecioModel extends BaseModel {
	...
	public PreciosEspeciales getRegistroPedidoEspecial(WebTable tablaPedidoEspecial, int row) {
		...
		//
		// int pricArticulo = (int) tablaPedidoEspecial.getValueAt(row,
		// CargaPrecioView.COL_ID_ESPECIFICO);
		//
		// if (tablaPedidoEspecial.getValueAt(row, CargaPrecioView.COL_1DESC_ESPECIFICO)
		// != null) {
		// pricDescuento1 = (BigDecimal) tablaPedidoEspecial.getValueAt(row,
		// CargaPrecioView.COL_1DESC_ESPECIFICO);
		// }
		//
		// if (tablaPedidoEspecial.getValueAt(row, CargaPrecioView.COL_2DESC_ESPECIFICO)
		// != null) {
		// pricDescuento2 = (BigDecimal) tablaPedidoEspecial.getValueAt(row,
		// CargaPrecioView.COL_2DESC_ESPECIFICO);
		// }
		//
		// String pricMoneda = (String) tablaPedidoEspecial.getValueAt(row,
		// CargaPrecioView.COL_MONEDA_ESPECIFICO);
		//
		// if (tablaPedidoEspecial.getValueAt(row,
		// CargaPrecioView.COL_PRECIO_ESPECIFICO) != null) {
		// pricPrecio = (BigDecimal) tablaPedidoEspecial.getValueAt(row,
		// CargaPrecioView.COL_PRECIO_ESPECIFICO);
		// }
		//
		// if (tablaPedidoEspecial.getValueAt(row, CargaPrecioView.COL_DESDE_ESPECIFICO)
		// != null) {
		// pricFechaDesde = (Date)(tablaPedidoEspecial.getValueAt(row,
		// CargaPrecioView.COL_DESDE_ESPECIFICO));
		// }
		//
		// if (tablaPedidoEspecial.getValueAt(row, CargaPrecioView.COL_HASTA_ESPECIFICO)
		// != null) {
		// pricFechaHasta = (Date)(tablaPedidoEspecial.getValueAt(row,
		// CargaPrecioView.COL_HASTA_ESPECIFICO));
		// }
		//
		// String pricReferencia = (String) tablaPedidoEspecial.getValueAt(row,
		// CargaPrecioView.COL_REFERENCIA_ESPECIFICO);
		//
		// PreciosEspeciales preciosEspeciales = new PreciosEspeciales(84, -1,
		// pricArticulo, pricDescuento1, pricDescuento2, pricMoneda, pricPrecio,
		// pricFechaDesde, pricFechaHasta,
		// pricReferencia);
		//
