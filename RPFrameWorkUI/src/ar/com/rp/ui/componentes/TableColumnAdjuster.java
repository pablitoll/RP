...
/**
 * Class that manages the widths of columns in a table.
 * 
 ...
 * 
 * This code was imported and adapted from
...
public final class TableColumnAdjuster implements PropertyChangeListener, TableModelListener {
	 ...
	 */
	public int adjustColumns() {
		int anchoTotal = 0;
		table.setAutoResizeMode(JTable.AUTO_RESIZE_ALL_COLUMNS);
		TableColumnModel tcm = table.getColumnModel();
		for (int i = 0; i < tcm.getColumnCount(); i++) {
			anchoTotal += adjustColumn(i);
		}
	 ...
	 */
	private int updateTableColumn(int column, int width) {
