...
public abstract class NumberToLetterConverter {
	 ...
	 */
	/*
	 * public static String convertNumberToLetter(String number) { return convertNumberToLetter(double number); }/*
	 * 
	 * /** Convierte un numero en representacion numerica a uno en representacion de texto. El numero es valido si esta entre 0 y 999'999.999 <p> Creation date 3/05/2006 - 05:37:47
	 * PM
	 * 
	...
	public static String convertNumberToLetter(double number, String separadorMiles, String separadorDecimal)  throws NumberFormatException {
		...
		String splitNumber[] = CommonUtils.double2String(doubleNumber, ",", ".").replace(".", "#").split("#");
		...
		int centavos = Integer
				.parseInt(String.valueOf(getDigitAt(splitNumber[1], 2)) + String.valueOf(getDigitAt(splitNumber[1], 1)) + String.valueOf(getDigitAt(splitNumber[1], 0)));
		
		converted += "CON " + String.valueOf(centavos) + "/00";
